...
func (o *CreateAccountCreated) Error() string {
	return fmt.Sprintf("[POST /users/{username}/accounts][%d] createAccountCreated  %+v", 201, o.Payload)
}
...
func (o *CreateAccountInternalServerError) Error() string {
	return fmt.Sprintf("[POST /users/{username}/accounts][%d] createAccountInternalServerError ", 500)
}
