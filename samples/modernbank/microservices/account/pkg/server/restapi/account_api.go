...
func NewAccountAPI(spec *loads.Document) *AccountAPI {
	return &AccountAPI{
...
func (o *AccountAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *AccountAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *AccountAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *AccountAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *AccountAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *AccountAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *AccountAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the AccountAPI
func (o *AccountAPI) Validate() error {
...
func (o *AccountAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *AccountAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *AccountAPI) Authorizer() runtime.Authorizer {
...
func (o *AccountAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *AccountAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *AccountAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the account API
func (o *AccountAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *AccountAPI) initHandlerCache() {
...
func (o *AccountAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *AccountAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *AccountAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
