...
// WithNumber adds the number to the delete account params
func (o *DeleteAccountParams) WithNumber(number int64) *DeleteAccountParams {
	o.SetNumber(number)
	return o
}

// SetNumber adds the number to the delete account params
func (o *DeleteAccountParams) SetNumber(number int64) {
	o.Number = number
}

// WithOwner adds the owner to the delete account params
func (o *DeleteAccountParams) WithOwner(owner string) *DeleteAccountParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the delete account params
func (o *DeleteAccountParams) SetOwner(owner string) {
	o.Owner = owner
}
