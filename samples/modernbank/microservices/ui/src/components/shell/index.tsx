    ...
    <>
      ...
      <Hidden mdUp={true}>
        <div className={props.classes.smDownContent}>
          <Grid container={true} className={props.classes.gridContainer}>
...
const MdUpComponent: React.FunctionComponent<IProps> = (props: IProps) => {
  const rightPanelElem = props.showRightPanel ? (
    <>
    ...
    <>
      <Grid
        item={true}
        className={props.classes.mdUpMainPanelWithoutRightPanel}
      >
        {props.children}
      </Grid>
    </>
